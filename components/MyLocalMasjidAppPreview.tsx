...
const MyLocalMasjidAppPreview = () => {
  return (
    <div className="relative flex justify-center items-center h-[700px]">
      ...
      >
        {/* Base Phone */}
        <div className="w-full h-full bg-gradient-to-br from-purple-900/30 via-blue-900/30 to-gray-950 rounded-[3rem] shadow-2xl border border-white/10" />
        ...
        >
          <div className="p-4 space-y-2">
            {[
              ...
              <div
                key={prayer.name}
                className={`h-11 rounded-lg flex items-center justify-between px-4 ${
                  prayer.name === 'Asr'
        ...
        <div className="absolute -top-10 -right-10 w-16 h-16 gradient-pink rounded-2xl opacity-60 backdrop-blur-sm" />
        <div className="absolute -bottom-10 -left-10 w-12 h-12 gradient-blue rounded-2xl opacity-60 backdrop-blur-sm" />
      </motion.a>
    </div>
  );
};
